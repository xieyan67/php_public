...
class MMysql {
    ...
    public function __construct(array $conf = []) {
        ...
        $this->_user = isset($conf['user']) ? $conf['user'] : $this->_user;
        $this->_pass = isset($conf['passwd']) ? $conf['passwd'] : $this->_pass;
        $this->_dbName = isset($conf['dbname']) ? $conf['dbname'] : $this->_dbName;
        //连接数据库
